...
-   FIXED:  On Pickup in store page, 'In store pickup' and 'Curbside pickup' list items present under 'Filter by' button are not keyboard accessible.
    ...
    [Bug] - Locked webpack version to '5.42.x' as latest minor release is breaking the build

    [HotFix Bug] Bug 1060219: Add support for editing profile page in commerce modules when entra external id is enabled.
    [Bug 1103842](https://msdyneng.visualstudio.com/FinOps/_workitems/edit/1103842):  Pin version for core-internal.